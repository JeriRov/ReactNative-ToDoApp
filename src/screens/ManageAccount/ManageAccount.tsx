...
import { User } from './manageAccount.types'
    ...
    >
      ...
      >
        ...
        <Avatar
          ...
          zIndex={20}
        />
        {(isAvatarLoading || isBackgroundLoading) && (
          <View
            position={'absolute'}
            alignSelf="center"
            zIndex={100}
      ...
      >
        ...
        >
          <SafeAreaView style={ManageAccountStyles.container}>
            <Input
              variant="unstyled"
              fontSize={16}
              px={1}
            ...
            <Text mt={1} style={ManageAccountStyles.validationError}>
              {errorMessage}
            </Text>
            <Button
              position={'relative'}
